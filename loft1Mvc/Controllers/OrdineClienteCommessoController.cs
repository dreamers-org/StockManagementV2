...
namespace StockManagement.Controllers
{
    ...
    public class OrdineClienteCommessoController : Controller
    {
        ...
        {
            var stockV2Context = _context.ViewOrdineClienteCommesso.OrderByDescending(x => x.DataInserimento);
        ...
        //            ordineCliente.Id = Guid.Parse(idOrdine);
        ...
        [Authorize]
        private void Execute(OrdineCliente ordineCliente, string emailCliente, string emailRappresentante, bool isLoft1)
        {
